...
@if (Session::has('delete_user'))
        <div class="alert alert-danger"data-auto-dismiss role="alert">{{ Session::get('delete_user') }}
                <button type="button" class="close" data-dismiss="alert">
                        <span aria-hidden="true">&times;</span>
                </button>
        </div>
...
@if (Session::has('update_user'))
        <div class="alert alert-success"data-auto-dismiss role="alert">{{ Session::get('update_user') }}
                <button type="button" class="close" data-dismiss="alert">
                        <span aria-hidden="true">&times;</span>
                </button>
        </div>
